                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="mb-5 text-lg leading-6 font-bold text-gray-900">
                                       Crear Tarea 
                                    </Dialog.Title>
                                    ...
                                    <form className="my-10" onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-5">
                                            ...
                                            className='text-gray-700 uppercase font-bold text-sm'>Descripcion Tarea</label>
                                            <textarea type="text" id='descripcion' placeholder='Nombre de la tarea'
                                            className='border-2 w-full p-2 mt-2 placeholder:gray-400 rounded-md' 
                                            value={descripcion}
                                        ...
                                        <div className="mb-5">
                                            ...
                                            className='text-gray-700 uppercase font-bold text-sm'>Prioridad: </label>
                                                <select type="text" id='prioridad' className='border-2 w-full p-2 mt-2 placeholder:gray-400 rounded-md' 
                                                value={prioridad}
                                        ...
                                        className='bg-sky-600 hover:bg-sky-400 w-full p-3 text-white uppercase 
